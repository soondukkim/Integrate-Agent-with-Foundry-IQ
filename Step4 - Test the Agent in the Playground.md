...
1. 답변 오른쪽 아래에 **디버그** 를 클릭하고 답변을 비교하세요.
   <img width="2000" height="1125" alt="image" src="https://github.com/user-attachments/assets/650af1c0-efb0-40b0-a7fc-983dba596d8a" />

1. 왼쪽의 **검색** 섹터에서 **추론 활동** 을 **최소** 또는 **중간** 으로 변경하면서 테스트 및 디버그를 참조해 보세요.
   <img width="2000" height="1125" alt="image" src="https://github.com/user-attachments/assets/2fe92bd1-f9dc-4989-8877-e9254a43135b" />
